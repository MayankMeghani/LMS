...
import {
  ...
  SiAngular, SiSvelte, SiNuxtdotjs, SiDjango, SiFlask,
  SiSpringboot, SiPydantic, SiRuby, SiPostgresql, SiMysql,
  SiRedis, SiApachecassandra, SiFirebase, SiKubernetes,
  SiTerraform, SiJenkins, SiGithubactions, SiFlutter,
  SiKotlin, SiSwift, SiTensorflow, SiPytorch, SiScikitlearn, SiAmazon
} from "react-icons/si";
  ...
  return (
      <div className="space-y-8">
        <div className="border-b border-base-300 pb-4">
          <h2 className="text-2xl font-bold text-base-content">What Will Students Learn?</h2>
          <p className="mt-2 text-base-content/70">List the key learning outcomes for your course</p>
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-base-200 p-4 rounded-lg space-y-1">
            ...
            <p className="text-sm text-base-content/70">Add clear, specific learning outcomes</p>
          </div>
        ...
        <div className="space-y-6 pt-4 border-t border-base-300">
          <div className="bg-base-200 p-4 rounded-lg space-y-1">
            <h3 className="font-medium text-base-content">Technologies Covered</h3>
            <p className="text-sm text-base-content/70">Select the technologies students will learn</p>
          </div>
